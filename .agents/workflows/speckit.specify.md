...
4. Follow this execution flow:
    ...
    3. **Validate against Backlog Context**:
       - Retrieve the `.specify/backlog/<product-name>-backlog.md` (or relevant backlog file).
...
5. Write the specification to SPEC_FILE using the template structure, replacing placeholders with details derived from the feature description (arguments) while preserving section order and headings.

6. **Specification Quality Validation**: After writing the initial spec, validate it against quality criteria:

   a. **Create Spec Quality Checklist**: Generate a checklist file at `FEATURE_DIR/checklists/requirements.md`. To do this:
      - Load the `.specify/templates/requirements-checklist-template.md` file.
      - Copy its contents and populate the placeholders (Feature Name, Date, Link to spec.md).
      - Save the populated checklist to `FEATURE_DIR/checklists/requirements.md`.
