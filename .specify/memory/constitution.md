...
- **Images:** Content photography MUST use local assets from the `images-small` folder, optimized to `.webp`. Selection MUST follow `.specify/context/images-list.md` descriptions. Technical SVGs and icons are exempt.
