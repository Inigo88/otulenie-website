...
- **Images:** Content photography MUST use local assets from the `images-small` folder, optimized to `.webp`. Technical SVGs and brand icons are exempt. Never use Unsplash or external photoshoot-style photography.
